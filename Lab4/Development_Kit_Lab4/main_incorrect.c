...
int main (int argc, char* argv[]){
    ...
    my_displacement = loc_nodecount_most * my_rank;
    my_nodecount = loc_nodecount_most;
    my_endnode = my_nodecount + my_displacement;

    printf("hello from rank %d of %d, loc n = %d, disp=%d, [%d, %d)\n",
        my_rank, mpi_size, my_nodecount, my_displacement, my_displacement, my_endnode);
